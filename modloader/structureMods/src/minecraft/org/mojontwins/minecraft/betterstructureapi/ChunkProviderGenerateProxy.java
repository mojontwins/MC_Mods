...
public class ChunkProviderGenerateProxy implements IChunkProvider {
	...
	public Chunk prepareChunk(int chunkX, int chunkZ) {
		return this.originalProvider.prepareChunk(chunkX, chunkZ);
	}
	...
	public boolean unload100OldestChunks() {
		return this.originalProvider.unload100OldestChunks();
	}

	@Override
	public boolean canSave() {
		return this.originalProvider.canSave();
	}

	@Override
	public String makeString() {
		return this.originalProvider.makeString();
	}

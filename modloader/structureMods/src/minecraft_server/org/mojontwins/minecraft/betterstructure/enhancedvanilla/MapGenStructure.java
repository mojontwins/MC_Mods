...
public abstract class MapGenStructure extends MapGenBase {
	...
	@Override
	public void func_667_a(IChunkProvider iChunkProvider1, World world2, int i3, int i4, byte[] b5) {
		super.func_667_a(iChunkProvider1, world2, i3, i4, b5);
	}

	@Override
	protected void func_666_a(World world, int cX, int cZ, int chunkX, int chunkZ, byte[] blockArray) {
	...
	public ChunkPosition getNearestInstance(World world1, int i2, int i3, int i4) {
		...
		this.func_666_a(world1, i2 >> 4, i4 >> 4, 0, 0, (byte[])null);
